...
public class User implements Serializable {
	...
	@Column(name = "term_condition", length = 1, columnDefinition = "boolean  default 0")
	@AssertTrue(message="please accept term & consition")
	...
	@Column(name = "last_login", length = 1, nullable = true, unique = false, columnDefinition = "Date")
